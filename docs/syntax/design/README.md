...
2. [JSON-like Authoring Syntax 记录](./json-like-authoring-syntax-record.md)
...
| [JSON-like Authoring Syntax 记录](./json-like-authoring-syntax-record.md) | 决策记录 | 保存本轮讨论背景、取舍、多入多出节点映射、`steps` 定位和 linter 约束。 |
...
| [JSON 超集 DocumentNode 语法草稿](./json-superset-documentnode-draft.md) | 替代草稿 | 评估严格接近 JSON/JSON5 的结构化 authoring 成本。 |
